...
namespace Task8.ElectricityMetering
{
    internal class ElectricityMetering
    {
        ...
        public static ElectricityMetering operator +(ElectricityMetering a, ElectricityMetering b)
        {
            a.Flats = a.Flats.Union(b.Flats).ToArray();
            return a;
        }
        public static ElectricityMetering operator -(ElectricityMetering a, ElectricityMetering b)
        {
            a.Flats = a.Flats.Except(b.Flats).ToArray();
            return a;
        }
